...
public class RedisKeyUtil {
     ...
     */
    private static final String RESET_PWD_TOKEN_KEY = "shop:restPwd";
    private static final String ACTIVE_USER = "shop:activeUser";
    private static final String SEND_SMS_COUNT = "shop:sms:count";
    private static final String SEND_EMAIL_CODE = "shop:email:code";
    private static final String ACCESS_TOKEN = "shop:token:accessToken";
    private static final String UPLOAD_FILE_SIZE = "shop:file:upload_file_size";
